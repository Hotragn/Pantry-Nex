...
//     { title: 'Tip 1', description: '🎉 Stay organized and avoid waste by keeping track of your pantry contents.' },
//     { title: 'Tip 2', description: '🚀 Description of Feature 2' },
//     { title: 'Tip 3', description: '✨ Description of Feature 3' },
//     { title: 'Feature 1', description: '🌟 Description of Feature 4' },
//     { title: 'Feature 2', description: '🔥 Description of Feature 5' },
//     { title: 'Feature 3', description: '💡 Description of Feature 6' },
//   ]);

//   const technologyStack = [
//     { name: 'Frontend', technologies: ['Material UI', 'Next.js'] },
//     { name: 'Backend', technologies: ['Firebase Firestore', 'Firebase Authentication', 'Firebase Storage'] },
//     { name: 'Deployment', technologies: ['Vercel'] },
//     { name: 'AI Integration', technologies: ['OpenAI'] },
//   ];
...
//       {/* Transition Section with Introduction */}
//       <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '40px' }}>
//         <Grow in={showContent} style={{ transformOrigin: '0 0 0' }} {...(showContent ? { timeout: 1000 } : {})}>
//           <Typography variant="h2" gutterBottom sx={{ color: '#3f51b5' }}>
//             🎊 Welcome to Our Fun-tastic Website! 🎊
//           </Typography>
//         </Grow>
//       </Box>

//       {/* Key Features Cards Section */}
//       <Grid container spacing={2} style={{ overflowX: 'auto', paddingBottom: '20px' }}>
//         {features.map((feature, index) => (
//           <Grid item xs={12} sm={6} md={4} key={feature.title}>
//             <Grow in={true} style={{ transformOrigin: '0 0 0' }} timeout={(index + 1) * 500}>
//               <StyledCard elevation={3}>
//                 <CardContent>
//                   <Typography variant="h5" sx={{ fontWeight: 'bold' }}>{feature.title}</Typography>
//                   <Typography variant="body2" sx={{ fontStyle: 'italic' }}>{feature.description}</Typography>
//                 </CardContent>
//                 <CardActions>
...
const HeroCard = styled(Card)(({ theme }) => ({
    ...
    height: '400px',
    backgroundImage: `url(https://mui.com/static/logo.png)`, // Replace with background image path
